...
QT_MOC_LITERAL(1, 7, 17), // "searchTextEntered"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 4), // "text"
QT_MOC_LITERAL(4, 31, 23) // "on_SearchButton_clicked"

    },
    "Search\0searchTextEntered\0\0text\0"
...
void Search::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->searchTextEntered((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (Search::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Search::searchTextEntered)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Search::searchTextEntered(const QString & _t1)
{
